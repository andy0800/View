// backend/scripts/deleteAllViewers.js
// Script to safely delete all viewer user accounts from the database
...
async function deleteAllViewers() {
  try {
    ...
    console.log('\n⚠️  WARNING: This will permanently delete ALL viewer accounts!');
    ...
    const secondConfirmation = await promptUser('❓ Type "DELETE_ALL_VIEWERS" to confirm: ');
    if (secondConfirmation !== 'DELETE_ALL_VIEWERS') {
